                ...
                <c:if test="${application != null}">
                    ...
                    <div class="application-details">
                        ...
                        <div class="detail-group">
                            ...
                            <div class="detail-value">${application.createdByName}</div>
                        </div>
                        ...
                        <div class="detail-group">
                            ...
                            <div class="detail-value">${application.leaveOnPersonName}</div>
                        </div>

                        <div class="detail-group">
                            <div class="detail-label">Processed By</div>
                            <div class="detail-value">
                                ${empty application.processedByName ? 'Not processed yet' : application.processedByName}
                            </div>
                        </div>
                        ...
                        <c:if test="${not empty application.note}">
                            <div class="detail-group reason-box">
                                ...
                                <div class="detail-value">${application.note}</div>
                            </div>
                        </c:if>
                    </div>

                    <c:if test="${sessionScope.employee.employeeId != application.createdBy && application.status == 'In progress'}">
                        <div class="approval-section">
                            <h2>Process Application</h2>
                            <form action="applicationDetail" method="POST" class="approval-form">
